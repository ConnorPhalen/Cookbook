...
namespace TechnicalProgrammingProject.Extensions
{
    ...
    {
        public static MvcHtmlString Image(this HtmlHelper helper, byte[] image, object htmlAttributes = null)
        {
            ...
            var img = string.Format("data:image/gif;base64,{0}", imageString);
